...
<% boolean show = Boolean.parseBoolean(request.getAttribute("show").toString());
    Restaurant restaurant = (Restaurant) request.getAttribute("restaurant");
    String street = "";
    String building = "";
    if (restaurant != null && restaurant.getAddress() != null) {
        street = restaurant.getAddress().getString("street");
        building = restaurant.getAddress().getString("building");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <form class="d-flex" role="search" method="post" action="query">
                                <input type="hidden" name="_method" value="GET" />
                                <input class="form-control me-2" type="number"
                                       name="restaurantId" placeholder="Enter an id"  id="id"
                                       value = "<c:out default="" value="${restaurant.getId()}" />">
                                <button class="btn btn-outline-primary" type="submit">Search</button>
                            </form>
                        </div>
                        <div class="col-6">
                            <label for="name">Find By Restaurant Name:</label>
                            <form class="d-flex" method="post" role="search" action="query">
                                <input type="hidden" name="_method" value="GET" />
                                <input class="form-control me-2" type="search"
                                       name="name" placeholder="Enter the restaurant name" id ="name">
                                <button class="btn btn-outline-primary" type="submit">Search</button>
                            </form>
                        </div>
                        <c:if test="${show}" >
                            <div class="col-10 offset-1" style="margin-top:2em">
                                <form class="row g-3 px-0 mx-0" method="post" action="query">
                                    <input type="hidden" name="_method" value="PUT" />
                                    <input hidden name = "id" value="<c:out default="" value="${restaurant.getId()}" />"> 
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="res-name" name="name" placeholder="example: Wistupiku"
                                               value = "<c:out default="" value="${restaurant.getName()}" />"   />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="res-city" name="borough" placeholder="example: La Paz - Bolivia"
                                               value = "<c:out default="" value="${restaurant.getBorough()}" />">
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="res-cuisine" name="cuisine"  >
                                            ...
                                            <option value="<c:out value="${restaurant.getCuisine()}"/>" selected><c:out value="${restaurant.getCuisine()}"/></option>
                                            <c:forEach var="cuisine" items="${cuisines}">
                                                <c:if test="${cuisine!=restaurant.getCuisine()}">
